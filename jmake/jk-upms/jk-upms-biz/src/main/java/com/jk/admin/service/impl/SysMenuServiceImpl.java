...
import com.jk.admin.api.entity.SysMenu;
import com.jk.admin.api.entity.SysRoleMenu;
import com.jk.admin.mapper.SysMenuMapper;
import com.jk.admin.mapper.SysRoleMenuMapper;
import com.jk.admin.service.SysMenuService;
import com.jk.common.core.constant.CacheConstants;
import com.jk.common.core.constant.CommonConstants;
import com.jk.common.core.constant.enums.MenuTypeEnum;
...
public class SysMenuServiceImpl extends ServiceImpl<SysMenuMapper, SysMenu> implements SysMenuService {
    ...
    private Function<SysMenu, TreeNode<Long>> getNodeFunction() {
        return menu -> {
            ...
            extra.put("component", menu.getPath());
            extra.put("order", menu.getSortOrder());
            ...
            if ("1".equals(menu.getEmbedded()) && menu.getPath() != null && menu.getPath().startsWith("http")) {
                meta.put("iframeSrc", menu.getPath());
            } else if (menu.getPath() != null && menu.getPath().startsWith("http")) {
