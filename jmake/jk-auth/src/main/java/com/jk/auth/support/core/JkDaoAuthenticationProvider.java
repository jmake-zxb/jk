package com.jk.auth.support.core;

import cn.hutool.core.util.StrUtil;
import cn.hutool.extra.spring.SpringUtil;
import com.jk.common.core.util.WebUtils;
import com.jk.common.security.service.JkUserDetailsService;
...
import static com.jk.common.core.constant.SecurityConstants.PASSWORD;
/**
 * 基于DAO的认证提供者实现，用于处理用户名密码认证
 *
 * @author 1661
 */
public class JkDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
	...
	public JkDaoAuthenticationProvider() {
	...
	protected final UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication) {
		...
		Map<String, JkUserDetailsService> userDetailsServiceMap = SpringUtil
			.getBeansOfType(JkUserDetailsService.class);

		String finalClientId = clientId;
		Optional<JkUserDetailsService> optional = userDetailsServiceMap.values()
			.stream()
