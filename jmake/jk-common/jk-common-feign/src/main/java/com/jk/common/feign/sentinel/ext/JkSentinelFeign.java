package com.jk.common.feign.sentinel.ext;
...
public class JkSentinelFeign {

    private JkSentinelFeign() {

    }

    public static JkSentinelFeign.Builder builder() {
        return new JkSentinelFeign.Builder();
    }
    ...
    public static final class Builder extends Feign.Builder implements ApplicationContextAware {
        ...
        @Override
        public JkSentinelFeign.Builder contract(Contract contract) {
            ...
            super.invocationHandlerFactory(new InvocationHandlerFactory() {
                ...
                public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
                    ...
                    if (void.class != fallback) {
                        ...
                        return new JkSentinelInvocationHandler(target, dispatch,
                    ...
                    if (void.class != fallbackFactory) {
                        ...
                        return new JkSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
                    }
                    return new JkSentinelInvocationHandler(target, dispatch);
                }
