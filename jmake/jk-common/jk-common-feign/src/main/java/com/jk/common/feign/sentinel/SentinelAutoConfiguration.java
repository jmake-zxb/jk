package com.jk.common.feign.sentinel;
...
import com.jk.common.feign.sentinel.handle.JkUrlBlockHandler;
import com.jk.common.feign.sentinel.parser.JkHeaderRequestOriginParser;
import feign.Feign;
...
public class SentinelAutoConfiguration {
    ...
    public BlockExceptionHandler blockExceptionHandler(ObjectMapper objectMapper) {
        return new JkUrlBlockHandler(objectMapper);
    }
    ...
    public RequestOriginParser requestOriginParser() {
        return new JkHeaderRequestOriginParser();
    }
}
