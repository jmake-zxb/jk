...
import com.jk.admin.api.feign.RemoteUserService;
...
public class JkAppUserDetailsServiceImpl implements JkUserDetailsService {
	...
	public UserDetails loadUserByUsername(String phone) {
		...
		if (cache != null && cache.get(phone) != null) {
			return (JkUser) cache.get(phone).get();
		}
	 ...
	 */
	@Override
	public UserDetails loadUserByUser(JkUser jkUser) {
		return this.loadUserByUsername(jkUser.getPhone());
	}
