...
public class JkResourceServerAutoConfiguration {
	 ...
	 */
	@Bean
	public JkBearerTokenExtractor pigBearerTokenExtractor(PermitAllUrlProperties urlProperties) {
		return new JkBearerTokenExtractor(urlProperties);
	}
	...
	public OpaqueTokenIntrospector opaqueTokenIntrospector(OAuth2AuthorizationService authorizationService) {
		return new JkCustomOpaqueTokenIntrospector(authorizationService);
	}
