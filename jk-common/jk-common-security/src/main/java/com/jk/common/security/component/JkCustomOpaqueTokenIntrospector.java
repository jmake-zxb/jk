...
public class JkCustomOpaqueTokenIntrospector implements OpaqueTokenIntrospector {
	...
	public OAuth2AuthenticatedPrincipal introspect(String token) {
		...
		try {
			...
			userDetails = optional.get().loadUserByUser((JkUser) tokenPrincipal);
		}
		...
		// 注入客户端信息，方便上下文中获取
        JkUser pigUser = (JkUser) userDetails;
