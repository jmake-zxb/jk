...
@Slf4j
public class JkSentinelInvocationHandler implements InvocationHandler {
    ...
    JkSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
    ...
    public boolean equals(Object obj) {
        if (obj instanceof SentinelInvocationHandler) {
            JkSentinelInvocationHandler other = (JkSentinelInvocationHandler) obj;
