package com.jk.common.feign.core;
...
/**
 * Jk Feign 内部请求拦截器，用于处理 Feign 请求的 Token 校验
 *
 * @author 1661
 */

public class JkFeignInnerRequestInterceptor implements RequestInterceptor, Ordered {
